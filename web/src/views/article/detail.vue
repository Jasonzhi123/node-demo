    ...
    <section class="container" v-if="detail">
      <section class="content">
        ...
        <div class="article-detail" id="article-detail">
          <mavon-editor style="height: 100%" :ishljs="true" v-model="detail.content" :defaultOpen="'preview'" :editable="false" :subfield="false" :toolbarsFlag="false">
          </mavon-editor>
        </div>
        <v-comments :commentsList=detail.comments_list @changeCommentsPage="changeCommentsPage" @updateComments="updateComments" :id="id"></v-comments>
      </section>
    </section>
  </section>
</template>
